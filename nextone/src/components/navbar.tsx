            ...
            {showDropdown && (
              <ul className="absolute top-full left-0 w-48 bg-customTealtoggle p-4" style={{ zIndex: 10 }}>
                <li className="hover:font-bold hover:text-white dark:text-white rounded-lg transition-all ">
                  ...
                  <Link href="/institucional/autoridades" className="text-white py-3 md:py-1 px-3 md:px-2 ">
                    Autoridades
                  </Link>
                ...
                <li className="hover:font-bold hover:text-white dark:text-white rounded-lg transition-all ">
                  ...
                  <Link href="/institucional/organigrama" className="text-white  hover:text-white hover:font-bold py-3 md:py-1 px-3 md:px-2">
                    Organigrama
                  </Link>
                ...
                <li className="hover:font-bold hover:text-white dark:text-white  rounded-lg transition-all  ">
                  ...
                  <Link href="/institucional/lineas-de-accion" className="text-white py-3 md:py-1 px-3 md:px-2">
                    Lineas de accion
                  </Link>
